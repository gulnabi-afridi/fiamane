...
function Index({ SignUpState, SignUpEvent, LoginState, LoginEvent }: Props) {
  ...
  const [carrier_typeDropDown, Setcarrier_typeDropDown] =
    React.useState<boolean>(false);
  const [carrier_typeValue, Setcarrier_typeValue] = React.useState<
    string | null
  >(null);
  ...
  return (
    ...
    >
      <div className={`md:w-[465px] w-full min-h-[600px]`}>
        {/* Title and cross bar */}
        <div
          className={`w-full h-[78px] px-6 flex ${
            !MainTab ? "justify-between" : "justify-end"
          } items-center`}
        >
          {!MainTab && (
            <button onClick={GoBack}>
              <Icons.ArrowBack
                ClassName="w-[25.2px] h-[19.6px]"
                fill="#1A1A1A"
              />
            </button>
          )}
          <button
            onClick={() => SignUpEvent(false)}
        ...
        <div className="w-full flex justify-center item-center flex-col mt-6 gap-5">
            ...
            <div className="w-full flex justify-center item-center flex-col px-8">
              ...
              <div className="w-full flex justify-center items-center flex-col gap-3 mt-8">
                <button
                  ...
                  className={`w-full h-[48px] rounded-[38px] hover:bg-brand-mainCool border-[1px] hover:border-brand-main flex justify-center items-center font-OpenSans font-semibold text-[#15181E] text-[14px] leading-[24px] text-center tracking-[-0.008em] ${
                    RegisterType === "client"
                      ? "border-brand-main bg-brand-mainCool"
                      : "border-[#E0E4EB]"
                  } `}
                >
          ...
          {SubTab && (
            <div className="w-full flex justify-center item-center flex-col gap-4 md:px-8 px-4">
              ...
              {/* Inputs */}
              <form
                onSubmit={VerifyEvent}
                className="w-full flex justify-center item-center flex-col gap-3 mt-2"
              >
                <div className="w-full h-[48px] rounded-[8px] overflow-hidden border-[1px] border-[#E6E6E6 flex justify-center items-center]">
                  ...
                  <div className="md:w-[90%] w-[85%] h-full">
                    <input
                      ...
                      type="email"
                      className="w-full h-full bg-transparent font-OpenSans font-normal text-[14px] leading-[24px] outline-none text-[#1A1A1A] placeholder:text-[#B3B3B3]"
                      placeholder={translate(
                        "Modals.Auth.Register.EmailStep.InputEmailPlaceholder"
                      )}
                    />
                  </div>
                </div>
                <div className="w-full h-[48px] rounded-[8px] overflow-hidden border-[1px] border-[#E6E6E6 flex justify-center items-center]">
                  ...
                  <div className="md:w-[90%] w-[85%] h-full">
                    <input
                      ...
                      className="w-full h-full bg-transparent font-OpenSans font-normal text-[14px] leading-[24px] outline-none text-[#1A1A1A] placeholder:text-[#B3B3B3]"
                      placeholder={translate(
                        "Modals.Auth.Register.EmailStep.InputPassPlaceholder"
                      )}
                    />
                  </div>
                </div>
                <div className="w-full h-[48px] rounded-[8px] overflow-hidden border-[1px] border-[#E6E6E6 flex justify-center items-center]">
                  ...
                  <div className="md:w-[90%] w-[85%] h-full">
                    <input
                      ...
                      className="w-full h-full bg-transparent font-OpenSans font-normal text-[14px] leading-[24px] outline-none text-[#1A1A1A] placeholder:text-[#B3B3B3]"
                      placeholder={translate(
                        "Modals.Auth.Register.EmailStep.InputConfirmPassPlaceholder"
                      )}
                    />
                  </div>
                </div>
                ...
                <button
                  type="submit"
                  className="w-full h-[48px] rounded-[8px] bg-brand-main flex justify-center items-center font-NunitoSans font-[600] text-[16px] leading-[24px] text-white-main mt-2"
                >
                ...
                <p className="font-NunitoSans font-[400] text-[12px] leading-[20px] text-[#7A7A7A] py-6 text-center m-auto md:max-w-[296px]">
                  {translate("Modals.Auth.Login.LoginStep.TermsAndConditions")}{" "}
                  <Link
                    onClick={() => SignUpEvent(false)}
                    href={""}
                  ...
                  >
                    {translate(
                      "Modals.Auth.Login.LoginStep.TermsAndConditionsLink"
                    )}
                  </Link>
                </p>
                ...
                <p className="font-OpenSans font-[400] text-[12px] leading-[20px] text-black-cool text-center pb-6">
                  {translate(
                    "Modals.Auth.Register.EmailStep.AlreadyHaveAccount"
                  )}{" "}
                  <span
                    onClick={() => {
                      SignUpEvent(false);
                    ...
                    className="text-brand-main font-semibold cursor-pointer"
                  >
                    {translate(
                      "Modals.Auth.Register.EmailStep.AlreadyHaveAccountLink"
                    )}
                  </span>
                </p>
              </form>
          ...
          {Verify && (
            <div className="w-full flex justify-center item-center flex-col px-8">
              ...
              <div className="w-full flex justify-center item-center flex-col gap-3 mt-8">
                ...
                <Dropdown
                  State={PyasDropDown}
                  Event={SetPyasDropDown}
                  GetValueEvent={SetPyasValue}
                  Placeholder={translate(
                    "Modals.Auth.Register.ClientInfoStep.SelectContryPlaceHolder"
                  )}
                  Item={PaysDropdownItem}
                />
                <div className="w-full h-[48px] rounded-[8px] border-[1px] border-[#E6E6E6] ] flex justify-center items-center">
                  {/* Country code dropDown */}
                  <div className="w-[25%] h-full">
                    <CountryCodeDropdown
                      Styles="w-full h-full z-100 rounded-r-[8px]"
                      Item={countries}
                      Placeholder="Code"
                      State={CountryCode}
                      Event={setCountryCode}
                  ...
                  <input
                    ...
                    onChange={InputChange}
                    type="number"
                    className="w-[75%] h-full bg-transparent font-OpenSans font-normal text-[14px] leading-[24px] outline-none text-[#1A1A1A] placeholder:text-[#B3B3B3]"
                    placeholder="Nom et prénom"
                  />
                </div>
                {/* <PhoneInput
          ...
          {CarrierFinalTab && (
            <div className="w-full flex justify-center item-center flex-col px-8">
              ...
              <form
                onSubmit={SignUp}
                className="w-full flex justify-center item-center flex-col gap-3 mt-8"
              >
                <div className="w-full h-[48px] rounded-[8px] overflow-hidden border-[1px] border-[#E6E6E6] flex justify-center items-center]">
                  <div className="md:w-[10%] w-[15%] h-full flex justify-center items-center">
                    <Icons.Company
                  ...
                  <div className="md:w-[90%] w-[85%] h-full">
                    <input
                      ...
                      className="w-full h-full bg-transparent font-OpenSans font-normal text-[14px] leading-[24px] outline-none text-[#1A1A1A] placeholder:text-[#B3B3B3]"
                      placeholder={translate(
                        "Modals.Auth.Register.CompanyInfoStep.CompanyNamePlaceholder"
                      )}
                    />
                  </div>
                </div>
                <div className="w-full h-[48px] rounded-[8px] overflow-hidden border-[1px] border-[#E6E6E6] flex justify-center items-center]">
                  <input
                    ...
                    onChange={InputChange}
                    type="text"
                    className="w-full h-full bg-transparent font-OpenSans font-normal text-[14px] leading-[24px] outline-none text-[#1A1A1A] placeholder:text-[#B3B3B3] px-4"
                    placeholder={translate(
                      "Modals.Auth.Register.CompanyInfoStep.CompanyCodePlaceholder"
                    )}
                  />
                </div>
                <Dropdown
                  State={carrier_typeDropDown}
                  Event={Setcarrier_typeDropDown}
                  GetValueEvent={Setcarrier_typeValue}
                  Placeholder={translate(
                    "Modals.Auth.Register.CompanyInfoStep.SelectClientTypePLaceHolder"
                  )}
                  Item={carrier_typeDropdownItem}
                />
                {/* Button */}
                <button
                  type="submit"

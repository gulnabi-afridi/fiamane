      ...
      >
        <div className={`w-[465px] min-h-[600px] `}>
          ...
          <div className="w-full h-[78px] px-6 flex justify-end items-center">
            <button
              onClick={() => ForgetPasswordEvent(false)}
                  ...
                  <div className="md:w-[90%] w-[85%] h-full">
                    <input
                      ...
                      placeholder={translate(
                        "Modals.Auth.ForgotPassword.InputEmailPlaceholder"
                      )}
                    />
                  </div>
                </div>
          ...
          {IsEmailVerified && (
            <div className="w-full flex justify-center item-start flex-col md:px-8 px-4 mt-6">
              ...
              <form
                ...
                className="w-full flex justify-center item-center gap-3 flex-col mt-8"
              >
                <div className="w-full h-[48px] rounded-[8px] overflow-hidden border-[1px] border-[#E6E6E6 flex justify-center items-center]">
                  <div className="md:w-[90%] w-[85%] h-full">
                    <input
                      ...
                      className="w-full h-full pl-3 bg-transparent font-OpenSans font-normal text-[14px] leading-[24px] outline-none text-[#B3B3B3] placeholder:text-[#B3B3B3]"
                ...
                <div className="w-full h-[48px] rounded-[8px] overflow-hidden border-[1px] border-[#E6E6E6 flex justify-center items-center]">
                  <div className="md:w-[90%] w-[85%] h-full">
                    <input
                      ...
                      onChange={InputChange}
                      type={IsPasswordVisible.CPassword ? "text" : "password"}
                      className="w-full h-full pl-3 bg-transparent font-OpenSans font-normal text-[14px] leading-[24px] outline-none text-[#B3B3B3] placeholder:text-[#B3B3B3]"

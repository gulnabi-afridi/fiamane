        ...
        <div className="w-full flex justify-center item-center flex-col mt-6 gap-5">
          ...
          <div className="w-full flex justify-center item-center flex-col gap-4 md:px-8 px-4">
            ...
            >
                ...
                <div className="md:w-[90%] w-[85%] h-full">
                  <input
                    ...
                    placeholder={translate(
                      "Modals.Auth.Login.LoginStep.InputEmailPlaceholder"
                    )}
                  />
                </div>
              </div>
              <div className="w-full h-[48px] rounded-[8px] overflow-hidden border-[1px] border-[#E6E6E6 flex justify-center items-center]">
                ...
                <div className="md:w-[90%] w-[85%] h-full">
                  <input
                    ...
                    className="w-full h-full bg-transparent font-OpenSans font-normal text-[14px] leading-[24px] outline-none text-[#1A1A1A] placeholder:text-[#B3B3B3]"
                    placeholder={translate(
                      "Modals.Auth.Login.LoginStep.InputPassPlaceholder"
                    )}
                  />
                </div>
              </div>
              ...
              <button
                type="submit"
                className="w-full h-[48px] rounded-[8px] bg-brand-main flex justify-center items-center font-NunitoSans font-[600] text-[16px] leading-[24px] text-white-main"
              >
              ...
              <p className="font-OpenSans font-[400] text-[12px] leading-[20px] text-black-cool text-center pb-6">
                {translate("Modals.Auth.Login.LoginStep.DontHaveAccount")}{" "}
                <span
                  onClick={() => {
                    SignUpEvent(true);
                    LoginEvent(false);

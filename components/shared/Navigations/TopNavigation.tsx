...
function TopNavigation() {
  ...
  return (
    <React.Fragment>
      <div
        className={`w-full md:h-[100px] h-[70px] bg-white-main`}
        style={{ boxShadow: "0px 1px 16px -2px rgba(0, 0, 0, 0.08)" }}
      >
        <div className="w-full m-auto h-full lg:px-24 md:8 px-4 flex justify-between items-center">
          ...
          <div className="md:flex hidden justify-center items-center gap-6">
            ...
            <div className="inline-block relative language-dropdown">
              <button
                onMouseOver={() => setUserMenu(false)}
                className="w-[76px] h-[40px] border-[1px] border-[#E6E6E6] rounded-[8px] rounded-bl-[0px] p-2 flex justify-between items-center"
              >
                <Image
              ...
              <div
                className="absolute bg-white-main opacity-0 pointer-events-none top-[100%] left-0 rounded-bl-[8px] rounded-br-[8px] w-[65%] min-h-[162px] p-2 dropDown z-30 "
            ...
            <div className="relative inline-block User z-50">
              ...
              {UserMenu && (
                <div
                  ref={domNode}
                  className={`flex p-3 justify-center items-center flex-col bg-white-main Menu`}
                >
                  <div
                    onClick={() => {
      ...
      >
        <div className="w-full h-full bg-white-off">
          ...
          <div className="w-full px-4 py-3 flex justify-between items-center">
            <div className="flex justify-center items-center gap-4">
              ...
              <div className="inline-block relative language-dropdown">
                ...
                <div
                  className="absolute bg-white-main opacity-0 pointer-events-none top-[100%] left-0 rounded-bl-[8px] rounded-br-[8px] w-[65%] min-h-[162px] p-2 dropDown"
                  style={{ boxShadow: "0px 4px 4px rgba(0, 0, 0, 0.25)" }}
                >
                  {[1, 3, 4, 5, 6].map((item: number, index: number) => {
                    return (
                ...
                {UserMenu && (
                  ...
                  >
                    ...
                    <div className="flex justify-center items-center mt-2 gap-2">
                      ...
                      <button className="font-Roboto font-semibold text-brand-main text-[12px] leading-[20px] whitespace-nowrap">
                        Inscrivez-vous
                      </button>
                    </div>
                  </div>
          ...
          <div
            className={`w-full h-[40px] flex justify-center items-center my-3 gap-6 bg-brand-secondary`}
          >
            <button
              onClick={() => setMainMenu(true)}
              className={`font-NunitoSans font-semibold text-[16px] ${
                Is_SiteMenu ? "text-brand-main" : "text-white-main"
          ...
          {/* Menu */}
          {Is_SiteMenu && (
            <div className="w-full flex justify-center items-center flex-col gap-4 mt-8 p-4">
              {Data.TopNavigation.NavItems.map((item: any, index: number) => {
                return (
                  <Link
                    key={index}
                    ...
                    href={item.Route}
                    className="font-NunitoSans font-semibold text-brand-secondary text-[16px]"
                  >
                    {item.Name}
                  </Link>
                );
              ...
              {Data.LeftNavigation.NavItems.map((item: any, index: number) => {
                return (
                  <Link
                    ...
                    key={index}
                    href={item.Route}
                    className={`w-full h-[48px] flex justify-start items-center px-8 font-OpenSans text-[18px] leading-[28px] tracking-[-0.01em] hover:bg-brand-tertiary ${
                      Router.pathname === item.Route
                        ? "font-semibold bg-brand-tertiary text-white-main"
                        : "font-normal text-brand-secondary"
                    } `}
                  >
                    {item.Name}
                  </Link>
